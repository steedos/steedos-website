...
<div class={"lg:py-12 py-8 overflow-hidden " + containerClass}>
  <div class="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-screen-xl">
    <div class="relative lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
        ...
        {items && items.map(({ title, description }, idx) => (
          <li class="mt-6">
            <div class="flex">
              ...
              <div class="ml-4">
                {title && (
                <div class="text-lg mb-2 leading-6 font-medium text-gray-900">{title}</div>
                )}
                {description &&(
                <p class="mb-0 text-base leading-6 text-gray-500">
                  {description} 
                </p>)}
              </div>
            </div>
      ...
      <div class={"mt-10 mx-4 relative lg:mt-0 " + imageContainerClass}>
        ...
        <div class="relative mx-auto w-full rounded-lg shadow-lg lg:max-w-md sm:mx-4">
