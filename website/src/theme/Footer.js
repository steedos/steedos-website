...
<div className="relative bg-blue-800">
  <div className="max-w-screen-xl mx-auto py-8 px-4 lg:py-12 lg:flex lg:items-center lg:justify-between">
    ...
    <div className="flex lg:flex-shrink-0">
      <img className="h-32 w-32 m-4" src="/assets/contact_by_weixin.png"/>
    </div>
  </div>
</div>
  ...
  <div className="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
    <div className="xl:grid xl:grid-cols-3 xl:gap-8">
      <div className="xl:col-span-1">
        ...
        华炎魔方是新一代低代码开发工具，基于商业智能和模型驱动，只需编写少量代码，就能轻松便捷地创建智能化、移动化的企业应用。
        </p>
        <div className="mt-8 flex">
          <a href="tel://4008201612" className="text-gray-400 hover:text-gray-500">
            <span className="sr-only">Phone</span>
            <svg viewBox="0 0 20 20" fill="currentColor" class="phone w-6 h-6"><path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"></path></svg>
          </a>
          ...
          <a href="https://github.com/steedos/" className="ml-6 text-gray-400 hover:text-gray-500">
      ...
      <div className="mt-12 grid grid-cols-5 gap-8 xl:mt-0 xl:col-span-2">
          <div>
            ...
            <ul className="mt-4">
              <li>
                <a href="/platform/" className="text-base leading-6 text-gray-500 hover:text-gray-900">
                  平台概览
                </a>
              </li>
              <li className="mt-4">
              ...
              <li className="mt-4">
                <a href="/platform/try" className="text-base leading-6 text-gray-500 hover:text-gray-900">
                  试用
                </a>
              </li>
              <li className="mt-4">
          ...
          <div className="mt-12 md:mt-0">
            ...
            <ul className="mt-4">
              ...
              <li className="mt-4">
                <a href="/solutions/group/" className="text-base leading-6 text-gray-500 hover:text-gray-900">
                  集团管控
                </a>
              </li>
              <li className="mt-4">
          ...
          <div>
            ...
            <ul className="mt-4">
              <li className="mt-4">
                <a href="https://cn.steedos.com/" className="text-base leading-6 text-gray-500 hover:text-gray-900">
                  登录华炎云
                </a>
              </li>
              <li className="mt-4">
              ...
              <li className="mt-4">
                <a href="/company/contact-us" className="text-base leading-6 text-gray-500 hover:text-gray-900">
                  联系我们
                </a>
              </li>
            </ul>
          ...
          <div className="mt-12 md:mt-0">
            ...
            <ul className="mt-4">
              <li>
                <a href="/company/about-us" className="text-base leading-6 text-gray-500 hover:text-gray-900">
                  关于我们
                </a>
              </li>
              <li className="mt-4">
                <a href="/company/customers" className="text-base leading-6 text-gray-500 hover:text-gray-900">
                  成功案例
                </a>
              </li>
              <li className="mt-4">
              ...
              <li className="mt-4">
                <a href="tel://4008201612" className="text-base leading-6 text-gray-500 hover:text-gray-900">
                  400-820-1612
                </a>
              </li>
            </ul>
