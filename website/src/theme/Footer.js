            ...
            <div>
                {/* <div className="relative bg-gray-600">
                    <div
                        ...
                        <div className="">
                            <div
                                className="text-xl mb-4 leading-6 font-semibold uppercase tracking-wider text-gray-300">
                                对于华炎魔方有疑问？？
                            </div>
                            <div
                                className="my-6 text-white text-3xl leading-9 font-extrabold tracking-tight sm:text-4xl sm:leading-10">
