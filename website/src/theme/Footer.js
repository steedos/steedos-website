  ...
  <div className="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
    <div className="xl:grid xl:grid-cols-3 xl:gap-8">
      <div className="xl:col-span-1">
        ...
        华炎魔方是新一代低代码开发平台，基于商业智能和模型驱动，只需编写少量代码，就能轻松便捷地创建智能化、移动化的企业应用。
        </p>
        <div className="mt-8 flex">
          ...
          <a href="https://github.com/steedos/steedos-platform/" className="ml-6 text-gray-400 hover:text-gray-500">
        ...
        <div class="md:grid md:grid-cols-2 md:gap-8">
          <div>
            ...
            <ul className="mt-4">
              ...
              <li className="mt-4">
                <a href="/platform/lowcode/" className="text-base leading-6 text-gray-500 hover:text-gray-900">
                  低代码
                </a>
              </li>
              <li className="mt-4">
                <a href="/platform/cases" className="text-base leading-6 text-gray-500 hover:text-gray-900">
                  客户案例
                </a>
              </li>
              <li className="mt-4">
          ...
          <div className="mt-12 md:mt-0">
            ...
            <ul className="mt-4">
              ...
              <li className="mt-4">
                <a href="/products/purchase/" className="text-base leading-6 text-gray-500 hover:text-gray-900">
                  采购管理
                </a>
              </li>
              <li className="mt-4">
